...
test_that("read_L1 works", {
    ...
    # Single site
    x <- read_L1(variable = "gw-tds", path = "./test_data", site = "TMP", quiet = TRUE)
    ...
    expect_warning(read_L1("A", path = "./test_data", quiet = TRUE),
...
test_that("read_L2 works", {
    ...
    # Single site
    x <- read_L2(variable = "sonde-fdom-rfu", path = "./test_data", site = "OWC", quiet = TRUE)
    expect_s3_class(x, "data.frame")
    ...
    # Warns if no files found
    expect_warning(read_L2("A", path = "./test_data", quiet = TRUE),
                   regexp = "No files found")
})
