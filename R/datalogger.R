...
read_datalogger_file <- function(filename, quiet = FALSE, ...) {
    ...
    # The number and names of columns varies between sites, so we can't
    # hard-code this (unfortunately as it's much faster; see
    # https://github.com/COMPASS-DOE/compasstools/issues/12).
